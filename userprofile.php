...
<head>
    ...
    <title>Daily Stories - Profile</title>
            ...
            <div class="col-md-4">
                <div class="userprofilecard sticky-top p-5">
                    ...
                    <div class="userprofileitems">
                        <div class="upitem active"><a href="userprofile.php">Info</a></div>
            ...
            <div class="col-md-8">
                <div class="userprofilecard p-5">
                        <div class="d-flex justify-content-center pb-4">
                            <img class="userprofilepic" src="<?php echo htmlspecialchars($_SESSION['user_image']); ?>">
                        </div>
                        <div class="userinfo pt-4">
                            <div class="row">
                                ...
                                <hr class="pb-2" style="color: 2pc solid #bebbb0;">
                                <div class="col-md-4">
                                    <h3>Email:</h3>
                                </div>
                                <div class="col-md-8">
                                    <h3><?php echo htmlspecialchars($_SESSION['useremail']); ?></h3>
                                </div>
                                <hr class="pb-2" style="color: 2pc solid #bebbb0;">
                            </div>
                        </div>
